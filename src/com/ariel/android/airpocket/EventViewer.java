...
public class EventViewer extends Activity
{
	public static final String KEY_DATE =
		"com.ariel.android.airpocket.eventviewer.date";
	public static final String KEY_OBJ_ID =
		"com.ariel.android.airpocket.eventviewer.object_id";
	public static final String KEY_STATUS =
		"com.ariel.android.airpocket.eventviewer.status";
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		//if(labelName != null) {
			...
			//int resourceId = getResources().getIdentifier(labelName, "drawable", "com.ariel.android.airpocket");
